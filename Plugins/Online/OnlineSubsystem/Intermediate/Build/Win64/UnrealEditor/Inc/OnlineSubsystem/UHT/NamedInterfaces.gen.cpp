...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_user_Documents_Unreal_Projects_Onslaught_Plugins_Online_OnlineSubsystem_Source_Public_NamedInterfaces_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FNamedInterface::StaticStruct, Z_Construct_UScriptStruct_FNamedInterface_Statics::NewStructOps, TEXT("NamedInterface"), &Z_Registration_Info_UScriptStruct_NamedInterface, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNamedInterface), 2209727353U) },
		{ FNamedInterfaceDef::StaticStruct, Z_Construct_UScriptStruct_FNamedInterfaceDef_Statics::NewStructOps, TEXT("NamedInterfaceDef"), &Z_Registration_Info_UScriptStruct_NamedInterfaceDef, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNamedInterfaceDef), 3574690373U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UNamedInterfaces, UNamedInterfaces::StaticClass, TEXT("UNamedInterfaces"), &Z_Registration_Info_UClass_UNamedInterfaces, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UNamedInterfaces), 2752822378U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_user_Documents_Unreal_Projects_Onslaught_Plugins_Online_OnlineSubsystem_Source_Public_NamedInterfaces_h_304899569(TEXT("/Script/OnlineSubsystem"),
	Z_CompiledInDeferFile_FID_Users_user_Documents_Unreal_Projects_Onslaught_Plugins_Online_OnlineSubsystem_Source_Public_NamedInterfaces_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_user_Documents_Unreal_Projects_Onslaught_Plugins_Online_OnlineSubsystem_Source_Public_NamedInterfaces_h_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_Users_user_Documents_Unreal_Projects_Onslaught_Plugins_Online_OnlineSubsystem_Source_Public_NamedInterfaces_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_user_Documents_Unreal_Projects_Onslaught_Plugins_Online_OnlineSubsystem_Source_Public_NamedInterfaces_h_Statics::ScriptStructInfo),
	nullptr, 0);
// End Registration
