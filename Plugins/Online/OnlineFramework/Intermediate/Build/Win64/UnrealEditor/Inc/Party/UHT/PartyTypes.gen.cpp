...
struct Z_Construct_UScriptStruct_FPartyPlatformSessionInfo_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_OwnerPrimaryId_MetaData[] = {
#if !UE_BUILD_SHIPPING
...
const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FPartyPlatformSessionInfo_Statics::NewProp_SessionType = { "SessionType", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FPartyPlatformSessionInfo, SessionType), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_SessionType_MetaData), NewProp_SessionType_MetaData) };
const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FPartyPlatformSessionInfo_Statics::NewProp_SessionId = { "SessionId", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FPartyPlatformSessionInfo, SessionId), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_SessionId_MetaData), NewProp_SessionId_MetaData) };
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FPartyPlatformSessionInfo_Statics::NewProp_OwnerPrimaryId = { "OwnerPrimaryId", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FPartyPlatformSessionInfo, OwnerPrimaryId), Z_Construct_UScriptStruct_FUniqueNetIdRepl, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_OwnerPrimaryId_MetaData), NewProp_OwnerPrimaryId_MetaData) }; // 3410776867
...
const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FPartyPlatformSessionInfo_Statics::StructParams = {
	(UObject* (*)())Z_Construct_UPackage__Script_Party,
	nullptr,
	&NewStructOps,
...
UScriptStruct* Z_Construct_UScriptStruct_FPartyPlatformSessionInfo()
{
	...
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_PartyPlatformSessionInfo.InnerSingleton, Z_Construct_UScriptStruct_FPartyPlatformSessionInfo_Statics::StructParams);
	}
...
struct Z_Construct_UScriptStruct_FPartyPrivacySettings_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_PartyType_MetaData[] = {
#if !UE_BUILD_SHIPPING
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_PartyInviteRestriction_MetaData[] = {
#if !UE_BUILD_SHIPPING
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_bOnlyLeaderFriendsCanJoin_MetaData[] = {
#if !UE_BUILD_SHIPPING
...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FPartyPrivacySettings_Statics::NewProp_PartyType = { "PartyType", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FPartyPrivacySettings, PartyType), Z_Construct_UEnum_Party_EPartyType, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_PartyType_MetaData), NewProp_PartyType_MetaData) }; // 2443267494
...
const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FPartyPrivacySettings_Statics::StructParams = {
	(UObject* (*)())Z_Construct_UPackage__Script_Party,
	nullptr,
	&NewStructOps,
...
UScriptStruct* Z_Construct_UScriptStruct_FPartyPrivacySettings()
{
	...
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_PartyPrivacySettings.InnerSingleton, Z_Construct_UScriptStruct_FPartyPrivacySettings_Statics::StructParams);
	}
...
const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FOnlinePartyRepDataBase_Statics::StructParams = {
	(UObject* (*)())Z_Construct_UPackage__Script_Party,
	nullptr,
	&NewStructOps,
...
UScriptStruct* Z_Construct_UScriptStruct_FOnlinePartyRepDataBase()
{
	...
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_OnlinePartyRepDataBase.InnerSingleton, Z_Construct_UScriptStruct_FOnlinePartyRepDataBase_Statics::StructParams);
	}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_user_Documents_Unreal_Projects_Onslaught_Plugins_Online_OnlineFramework_Source_Party_Public_Party_PartyTypes_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EPartyType_StaticEnum, TEXT("EPartyType"), &Z_Registration_Info_UEnum_EPartyType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2443267494U) },
		{ EPartyInviteRestriction_StaticEnum, TEXT("EPartyInviteRestriction"), &Z_Registration_Info_UEnum_EPartyInviteRestriction, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1379033741U) },
		{ EPartyJoinDenialReason_StaticEnum, TEXT("EPartyJoinDenialReason"), &Z_Registration_Info_UEnum_EPartyJoinDenialReason, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 903920415U) },
		{ EApprovalAction_StaticEnum, TEXT("EApprovalAction"), &Z_Registration_Info_UEnum_EApprovalAction, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 443511029U) },
		{ ESocialPartyInviteMethod_StaticEnum, TEXT("ESocialPartyInviteMethod"), &Z_Registration_Info_UEnum_ESocialPartyInviteMethod, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1854820857U) },
		{ ESocialPartyInviteFailureReason_StaticEnum, TEXT("ESocialPartyInviteFailureReason"), &Z_Registration_Info_UEnum_ESocialPartyInviteFailureReason, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1309870327U) },
	};
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FPartyPlatformSessionInfo::StaticStruct, Z_Construct_UScriptStruct_FPartyPlatformSessionInfo_Statics::NewStructOps, TEXT("PartyPlatformSessionInfo"), &Z_Registration_Info_UScriptStruct_PartyPlatformSessionInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPartyPlatformSessionInfo), 3799803226U) },
		{ FPartyPrivacySettings::StaticStruct, Z_Construct_UScriptStruct_FPartyPrivacySettings_Statics::NewStructOps, TEXT("PartyPrivacySettings"), &Z_Registration_Info_UScriptStruct_PartyPrivacySettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPartyPrivacySettings), 2616550649U) },
		{ FOnlinePartyRepDataBase::StaticStruct, Z_Construct_UScriptStruct_FOnlinePartyRepDataBase_Statics::NewStructOps, TEXT("OnlinePartyRepDataBase"), &Z_Registration_Info_UScriptStruct_OnlinePartyRepDataBase, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOnlinePartyRepDataBase), 140430796U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_user_Documents_Unreal_Projects_Onslaught_Plugins_Online_OnlineFramework_Source_Party_Public_Party_PartyTypes_h_2091366856(TEXT("/Script/Party"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Users_user_Documents_Unreal_Projects_Onslaught_Plugins_Online_OnlineFramework_Source_Party_Public_Party_PartyTypes_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_user_Documents_Unreal_Projects_Onslaught_Plugins_Online_OnlineFramework_Source_Party_Public_Party_PartyTypes_h_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_Users_user_Documents_Unreal_Projects_Onslaught_Plugins_Online_OnlineFramework_Source_Party_Public_Party_PartyTypes_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_user_Documents_Unreal_Projects_Onslaught_Plugins_Online_OnlineFramework_Source_Party_Public_Party_PartyTypes_h_Statics::EnumInfo));
// End Registration
