...
struct Z_Construct_UClass_ASpectatorBeaconClient_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_ASpectatorBeaconClient_ClientCancelReservationResponse, "ClientCancelReservationResponse" }, // 69914955
		{ &Z_Construct_UFunction_ASpectatorBeaconClient_ClientReservationResponse, "ClientReservationResponse" }, // 2626518773
		{ &Z_Construct_UFunction_ASpectatorBeaconClient_ClientSendReservationFull, "ClientSendReservationFull" }, // 4164832545
		{ &Z_Construct_UFunction_ASpectatorBeaconClient_ClientSendReservationUpdates, "ClientSendReservationUpdates" }, // 2055734505
		{ &Z_Construct_UFunction_ASpectatorBeaconClient_ServerCancelReservationRequest, "ServerCancelReservationRequest" }, // 1290156965
		{ &Z_Construct_UFunction_ASpectatorBeaconClient_ServerReservationRequest, "ServerReservationRequest" }, // 502475172
	};
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_user_Documents_Unreal_Projects_Onslaught_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Public_SpectatorBeaconClient_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ ESpectatorClientRequestType_StaticEnum, TEXT("ESpectatorClientRequestType"), &Z_Registration_Info_UEnum_ESpectatorClientRequestType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3097183281U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ASpectatorBeaconClient, ASpectatorBeaconClient::StaticClass, TEXT("ASpectatorBeaconClient"), &Z_Registration_Info_UClass_ASpectatorBeaconClient, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ASpectatorBeaconClient), 3669440703U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_user_Documents_Unreal_Projects_Onslaught_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Public_SpectatorBeaconClient_h_3891702180(TEXT("/Script/OnlineSubsystemUtils"),
	Z_CompiledInDeferFile_FID_Users_user_Documents_Unreal_Projects_Onslaught_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Public_SpectatorBeaconClient_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_user_Documents_Unreal_Projects_Onslaught_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Public_SpectatorBeaconClient_h_Statics::ClassInfo),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Users_user_Documents_Unreal_Projects_Onslaught_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Public_SpectatorBeaconClient_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_user_Documents_Unreal_Projects_Onslaught_Plugins_Online_OnlineSubsystemUtils_Source_OnlineSubsystemUtils_Public_SpectatorBeaconClient_h_Statics::EnumInfo));
// End Registration
